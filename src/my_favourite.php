    ...
    <div class='box'>
        ...
        <filter id="filter">
            ...
            <script>
                ...
                $sql = "select ImageID from travelimagefavor where UID='$uid' LIMIT $pn,$page";
                $result = mysqli_query($mysqli, $sql); //执行sql
                ...
                <a href='delete_favourite.php?ImageID=$ImageID&uid=$uid' class='button' style='right: 280px; color: red;' name='button2'>删除</a>
            </ul>";
                }
            }
